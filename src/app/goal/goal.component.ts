...
export class GoalComponent implements OnInit {
  ...
  goals: Goal[] = [
    new Goal(1, 'Watching Nemo', 'Find an online version and watch merlin find his son', new Date(2019, 3, 14)),
    new Goal(2, 'Buy Cookies', 'I have to but cookies for the parrot', new Date(2019, 6, 9)),
